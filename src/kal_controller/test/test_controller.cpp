...
protected:
    void SetUp() override {
        ...
        parameters_.kAngle = 0.5;
        parameters_.kDistance = 0.5;
...
TEST_F(ControllerTest, speed) {
    // The speed of the returned control command should always match the speed implied by the trajectory.
    ...
    EXPECT_DOUBLE_EQ(controlCommand.speed, desiredSpeed_);
}
