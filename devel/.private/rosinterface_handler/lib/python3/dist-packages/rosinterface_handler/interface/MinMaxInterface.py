...
inf = float('inf')
param_description = [{'name': 'int_param_w_minmax', 'type': 'int', 'default': 3, 'level': 0, 'edit_method': '""', 'description': 'An Integer parameter', 'min': 0, 'max': 2, 'is_vector': False, 'is_map': False, 'configurable': False, 'constant': False, 'global_scope': False, 'pytype': 'int'}, {'name': 'double_param_w_minmax', 'type': 'double', 'default': 3.1, 'level': 0, 'edit_method': '""', 'description': 'A double parameter', 'min': 0.0, 'max': 2.0, 'is_vector': False, 'is_map': False, 'configurable': False, 'constant': False, 'global_scope': False, 'pytype': 'double'}, {'name': 'vector_int_param_w_minmax', 'type': 'std::vector<int>', 'default': [-1, 2, 3], 'level': 0, 'edit_method': '""', 'description': 'A vector of int parameter', 'min': 0, 'max': 2, 'is_vector': True, 'is_map': False, 'configurable': False, 'constant': False, 'global_scope': False}, {'name': 'vector_double_param_w_minmax', 'type': 'std::vector<double>', 'default': [-1.1, 1.2, 2.3], 'level': 0, 'edit_method': '""', 'description': 'A vector of double parameter', 'min': 0.0, 'max': 2.0, 'is_vector': True, 'is_map': False, 'configurable': False, 'constant': False, 'global_scope': False}, {'name': 'map_param_w_minmax', 'type': 'std::map<std::string,double>', 'default': {'value1': -1.2, 'value2': 1.2, 'value3': 2.2}, 'level': 0, 'edit_method': '""', 'description': 'A map parameter', 'min': 0.0, 'max': 2.0, 'is_vector': False, 'is_map': True, 'configurable': False, 'constant': False, 'global_scope': False}]
subscriber_description = []
publisher_description = []
verbosity_param = None
tf_config = None
