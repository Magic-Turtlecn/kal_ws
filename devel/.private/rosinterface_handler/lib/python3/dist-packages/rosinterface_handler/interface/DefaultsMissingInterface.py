...
inf = float('inf')
param_description = [{'name': 'int_param', 'type': 'int', 'default': None, 'level': 0, 'edit_method': '""', 'description': 'Handler should keep node from starting, when no default is given here or at launch.', 'min': None, 'max': None, 'is_vector': False, 'is_map': False, 'configurable': False, 'constant': False, 'global_scope': False, 'pytype': 'int'}]
...
class DefaultsMissingInterface(dict):
    def __init__(self):
