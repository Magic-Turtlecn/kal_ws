...
struct MinMaxInterface {
  ...
  void fromParamServer(){
    ...
    success &= rosinterface_handler::getParam(privateNamespace_ + "map_param_w_minmax", map_param_w_minmax, std::map<std::string,double>{{"value1",-1.2},{"value2",1.2},{"value3",2.2}});
...
;
  ...
  void showNodeInfo() const {
      std::string message = "Node '" + nodeName() + "' from package 'rosinterface_handler', type 'MinMax'"
