...
struct DefaultsAtLaunchInterface {
  ...
  void fromParamServer(){
    bool success = true;
    success &= rosinterface_handler::getParam(privateNamespace_ + "verbosity_param_wo_default", verbosity_param_wo_default);
    rosinterface_handler::setLoggerLevel(privateNodeHandle_, "verbosity_param_wo_default", nodeNameWithNamespace());
    ...
    success &= rosinterface_handler::getParam(privateNamespace_ + "long_param_wo_default_int", long_param_wo_default_int);
    success &= rosinterface_handler::getParam(privateNamespace_ + "long_param_wo_default_int_str", long_param_wo_default_int_str);
    success &= rosinterface_handler::getParam(privateNamespace_ + "long_param_wo_default_long_str", long_param_wo_default_long_str);
    ...
    success &= rosinterface_handler::getParam(privateNamespace_ + "enum_int_param_wo_default", enum_int_param_wo_default);
    ...
    success &= rosinterface_handler::getParam(privateNamespace_ + "enum_str_param_wo_default", enum_str_param_wo_default);
  ...
  void toParamServer(){
    ...
    rosinterface_handler::setParam(privateNamespace_ + "long_param_wo_default_int",long_param_wo_default_int);
    rosinterface_handler::setParam(privateNamespace_ + "long_param_wo_default_int_str",long_param_wo_default_int_str);
    rosinterface_handler::setParam(privateNamespace_ + "long_param_wo_default_long_str",long_param_wo_default_long_str);
  ...
  friend std::ostream& operator<<(std::ostream& os, const DefaultsAtLaunchInterface& p)
  {
    os << "[" << p.nodeNameWithNamespace() << "]\nNode " << p.nodeNameWithNamespace() << " has the following parameters:\n"
      ...
      << "	" << p.privateNamespace_ << "long_param_wo_default_int:" << p.long_param_wo_default_int << "\n"
      << "	" << p.privateNamespace_ << "long_param_wo_default_int_str:" << p.long_param_wo_default_int_str << "\n"
      << "	" << p.privateNamespace_ << "long_param_wo_default_long_str:" << p.long_param_wo_default_long_str << "\n"
...
;
  ...
  void showNodeInfo() const {
      std::string message = "Node '" + nodeName() + "' from package 'rosinterface_handler', type 'DefaultsAtLaunch'"
                                                    " in namespace '" + publicNamespace_ + "'.\nSubscribed to: [";
      message +=  subscriber_wo_default->getTopic();
      message += ", " + subscriber_public_wo_default->getTopic();
      message += ", " + subscriber_global_wo_default->getTopic();
      message += "]\nAdvertising: [";
      message +=  publisher_wo_default.getTopic();
      message += ", " + publisher_public_wo_default.getTopic();
      message += ", " + publisher_global_wo_default.getTopic();
      message += ']';
      logInfo(message);
  }
...
public:
  ...
  int64_t long_param_wo_default_int; /*!< A long parameter */
  int64_t long_param_wo_default_int_str; /*!< A long parameter */
  int64_t long_param_wo_default_long_str; /*!< A long parameter */
...
private:
  ...
  void missingParamsWarning(){
    ROS_WARN_STREAM("[" << nodeName_ << "]\nThe following parameters do not have default values and need to be specified:\n"
      << "	" << privateNamespace_ << "verbosity_param_wo_default" << " (std::string) \n"
      ...
      << "	" << privateNamespace_ << "long_param_wo_default_int" << " (int64_t) \n"
      << "	" << privateNamespace_ << "long_param_wo_default_int_str" << " (int64_t) \n"
      << "	" << privateNamespace_ << "long_param_wo_default_long_str" << " (int64_t) \n"
      ...
      << "	" << privateNamespace_ << "enum_int_param_wo_default" << " (int) \n"
      << "	" << privateNamespace_ << "enum_str_param_wo_default" << " (std::string) \n"
